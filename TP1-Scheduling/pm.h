...
#define NANVIX_PM_H_
	 ...
	 */
	/**@{*/
	// -100 étant la plus grande priorité, et 40 la plus petite
	 ...
	 * @brief Process.
	 */
	struct process // A ne modifier que pour l'implémentation de la Lotterie
	{
		/**
    	...
    	/** Nice −20 is the highest priority, 19 is the lowest priority */
